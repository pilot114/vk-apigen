...
class Messages
{
    ...
    public function getChatPreview() : Method\Messages\GetChatPreview
    {
        return new Method\Messages\GetChatPreview($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    ...
    public function getImportantMessages() : Method\Messages\GetImportantMessages
    {
        return new Method\Messages\GetImportantMessages($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    public function getIntentUsers() : Method\Messages\GetIntentUsers
    {
        return new Method\Messages\GetIntentUsers($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    public function getInviteLink() : Method\Messages\GetInviteLink
    {
        return new Method\Messages\GetInviteLink($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    ...
    public function joinChatByInviteLink() : Method\Messages\JoinChatByInviteLink
    {
        return new Method\Messages\JoinChatByInviteLink($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    ...
    public function pin() : Method\Messages\Pin
    {
        return new Method\Messages\Pin($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    ...
    public function sendMessageEventAnswer() : Method\Messages\SendMessageEventAnswer
    {
        return new Method\Messages\SendMessageEventAnswer($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    ...
    public function unpin() : Method\Messages\Unpin
    {
        return new Method\Messages\Unpin($this->client, $this->defaultQuery, $this->accessTokenType);
    }
}