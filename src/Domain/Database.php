...
class Database
{
    ...
    public function getMetroStations() : Method\Database\GetMetroStations
    {
        return new Method\Database\GetMetroStations($this->client, $this->defaultQuery, $this->accessTokenType);
    }
    public function getMetroStationsById() : Method\Database\GetMetroStationsById
    {
        return new Method\Database\GetMetroStationsById($this->client, $this->defaultQuery, $this->accessTokenType);
    }
