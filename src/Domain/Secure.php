...
class Secure
{
    ...
    public function giveEventSticker() : Method\Secure\GiveEventSticker
    {
        return new Method\Secure\GiveEventSticker($this->client, $this->defaultQuery, $this->accessTokenType);
    }
