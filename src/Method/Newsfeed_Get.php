 ...
 */
class Newsfeed_Get extends \VkApigen\BaseMethod
{
     ...
     * {"type":"bool"}
     */
    public function _return_banned(bool $return_banned) : Newsfeed_Get
    {
     ...
     */
    public function _source_ids(array $source_ids) : Newsfeed_Get
    {
