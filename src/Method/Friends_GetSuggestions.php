 ...
 */
class Friends_GetSuggestions extends \VkApigen\BaseMethod
{
     ...
     */
    public function _count(int $count) : Friends_GetSuggestions
    {
     ...
     * {"type":"int","minimum":0}
     */
    public function _offset(int $offset) : Friends_GetSuggestions
    {
