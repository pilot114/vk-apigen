 ...
 */
class Wall_Edit extends \VkApigen\BaseMethod
{
     ...
     * {"type":"int"}
     */
    public function _owner_id(int $owner_id) : Wall_Edit
    {
     ...
     * {"type":"int","minimum":0}
     */
    public function post_id(int $post_id) : Wall_Edit
    {
     ...
     * {"type":"bool"}
     */
    public function _friends_only(bool $friends_only) : Wall_Edit
    {
     ...
     * {"type":"bool"}
     */
    public function _signed(bool $signed) : Wall_Edit
    {
     ...
     * {"type":"int","minimum":0}
     */
    public function _publish_date(int $publish_date) : Wall_Edit
    {
     ...
     * {"type":"int","minimum":0}
     */
    public function _place_id(int $place_id) : Wall_Edit
    {
     ...
     * {"type":"bool"}
     */
    public function _mark_as_ads(bool $mark_as_ads) : Wall_Edit
    {
